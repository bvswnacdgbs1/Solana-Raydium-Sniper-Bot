...
1. Download and extract the repository files: Use the command "git clone https://github.com/Dev-AhmedRabby/Solana-Raydium-Sniper-Bot" or click the green "Code" button and select "Download ZIP".
